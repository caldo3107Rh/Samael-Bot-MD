...
${isWin ? `@${(isSurrender ? room.game.currentTurn : room.game.winner).split('@')[0]} 𝙶𝙰𝙽𝙰𝚂𝚃𝙴 🥳, 𝚃𝙴 𝙻𝙻𝙴𝚅𝙰𝚂 𝚄𝙽 𝙱𝙴𝚂𝙾 𝙼𝙰𝚂 𝙼𝙸 𝚆𝙴𝙱𝙾 𝙲𝙻𝙰𝚁𝙾 𝚀𝚄𝙴 𝚂𝙸` : isTie ? '𝙴𝙻 𝙹𝚄𝙴𝙶𝙾 𝚃𝙴𝚁𝙸𝙽𝙾 𝙴𝙽 𝙴𝙼𝙿𝙰𝚃𝙴, 𝚁𝙴 𝙼𝙰𝙽𝙲𝙾𝚂😮‍💨' : `𝚃𝚄𝚁𝙽𝙾 𝙳𝙴 @${room.game.currentTurn.split('@')[0]}`}
`.trim()
