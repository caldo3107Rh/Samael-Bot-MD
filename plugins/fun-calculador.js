...
if (command == 'zorra') {
conn.reply(m.chat, `
_*${text.toUpperCase()}* *ES 🦊* *${(500).getRandom()}%* *ZORRA, PORFAVOR DEJA LO ZORRA🥱*_
`.trim(), m, m.mentionedJid ? {
mentions: m.mentionedJid
} : {})}
if (command == 'pervertid@') {
conn.reply(m.chat, `
_*${text.toUpperCase()}* *es 😳* *${(500).getRandom()}%* *Pervertid@, porfavor anda a una iglesia⛪️*_
`.trim(), m, m.mentionedJid ? {
mentions: m.mentionedJid
} : {})}
}
handler.help = ['gay2', 'lesbiana', 'pajero', 'pajera', 'puto', 'puta', 'manco', 'manca', 'rata', 'prostituta', 'prostituto', 'zorra', 'pervertid@'].map(v => v + ' @tag | nombre')
handler.tags = ['calculator']
handler.command = /^gay2|lesbiana|pajero|pajera|puto|puta|manco|manca|rata|prostituta|prostituto|zorra|pervertid@/i
